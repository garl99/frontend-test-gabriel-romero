...
const variantClasses: Record<TextVariant, string> = {
  ...
  [TextVariant.AccentSm]: "text-sm md:text-sm text-accent font-semibold",
  [TextVariant.AccentMd]: "text-sm md:text-xl text-accent font-normal",
  [TextVariant.AccentLg]: "text-sm md:text-7xl text-accent font-semibold",
  ...
  [TextVariant.SecondarySm]: "text-sm md:text-sm text-primary font-normal ",
  [TextVariant.SecondaryMd]: "text-sm md:text-base text-primary font-semibold",
  [TextVariant.Custom]: "",
};
